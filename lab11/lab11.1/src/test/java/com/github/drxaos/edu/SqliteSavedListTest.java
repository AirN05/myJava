...
public class SqliteSavedListTest {
    ...
    public void test1() throws Exception {
        ...
        String table1 = "list1";
        // create list
        SqliteSavedListAlt<String> list = new SqliteSavedListAlt<String>(table1);
        list.add("One");
        list.add("Two");
        list.add("Three");
        for (int i = 0; i < 100; i++) {
        ...
        SqliteSavedListAlt<String> list2 = new SqliteSavedListAlt<String>(table2);
        list2.add("One");
        list2.add("Two");
        list2.add("Three");
    ...
    public void test2() throws Exception {
        ...
        // create list
        SqliteSavedListAlt<String> list = new SqliteSavedListAlt<String>(table3);
        list.add("One");
        list.add("Two");
        list.add("Three");
        for (int i = 0; i < 100; i++) {
        ...
        // load list
        SqliteSavedListAlt<String> loadedList = new SqliteSavedListAlt<String>(table3);

        Assert.assertTrue(AltDB.table.containsKey(table3));
    ...
    public void test3() throws Exception {
        ...
        // create list
        SqliteSavedListAlt<String> list = new SqliteSavedListAlt<String>(table4);
        list.add("One");
        list.add("Two");
        list.add("Three");
        for (int i = 0; i < 100; i++) {
        ...
        SqliteSavedListAlt<String> loadedList = new SqliteSavedListAlt<String>(table4);
        ...
        list = new SqliteSavedListAlt<String>(table4);
        Assert.assertEquals(83, list.size());

        // remove file
       AltDB.table.remove(table4);
    ...
    public void test4() throws Exception {
        ...
        // create list
        SqliteSavedListAlt<Integer> list = new SqliteSavedListAlt<Integer>(table5);
        list.add(1);
        list.add(2);
        list.add(3);
        list.set(0, 999);
        ...
        // load list
        SqliteSavedListAlt<Integer> loadedList = new SqliteSavedListAlt<Integer>(table5);

        Assert.assertTrue(AltDB.table.containsKey(table5));
